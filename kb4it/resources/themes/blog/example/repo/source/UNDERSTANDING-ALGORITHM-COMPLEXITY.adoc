...
Common complexity classes, ordered from most to least efficient:

* *O(1)* — Constant time. The operation takes the same time regardless of input size. Example: array index access.
