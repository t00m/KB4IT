                ...
                <div class="uk-modal-dialog uk-height-viewport">
                    ...
                    <div class="uk-grid-collapse uk-child-width-expand@s uk-flex-middle" uk-grid>
                        <div class="uk-padding-large uk-background-muted">
                            ...
                            <div class="uk-text-lead">${var['basename_md']}&nbsp;<a onclick="copyToClipboard()" class="uk-icon-link uk-margin-small-right uk-link-toggle" uk-icon="copy; ratio: 1.0;" uk-tooltip="title: Copy to clipboard"></a></div>
