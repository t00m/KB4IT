...
% endif
    ...
    <ul class="uk-switcher uk-margin">
        <li class="uk-active"><div class="kb-content kb-content-${var.get('fmt', 'adoc')}">${var['source_html']}</div></li>
    </ul>
...
% else:
    <div class="kb-content kb-content-${var.get('fmt', 'adoc')}">${var['source_html']}</div>
% endif
