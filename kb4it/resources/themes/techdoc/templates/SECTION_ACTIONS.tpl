...
% if var['has_toc']:
        <li class="uk-link-toggle uk-card uk-card-hover uk-border-rounded"><!-- Edit Button :: START -->
        ...
        <li class="uk-link-toggle uk-card uk-card-hover uk-border-rounded"><!-- Print Button :: START -->
        ...
        <li class="uk-link-toggle uk-card uk-card-hover uk-border-rounded"><!-- Metadata Button :: START -->
            <a class=""uk-link-heading"" href="#modal-metadata" uk-toggle><div class="uk-grid-medium uk-flex-middle" uk-grid><div class="uk-width-auto uk-padding-remove-top uk-padding-remove-bottom"><span class="uk-link-heading" uk-icon="icon: hashtag; ratio: 1.0;"></span></div><div class="uk-width-auto uk-padding-small uk-padding-remove-top uk-padding-remove-bottom">Metadata</div></div></a>
        ...
        <li class="uk-link-toggle uk-card uk-card-hover uk-border-rounded"><!-- View Asciidoc Source Button :: START -->
            <a class="uk-link-heading" href="#modal-full-source" uk-toggle><div class="uk-grid-medium uk-flex-middle" uk-grid><div class="uk-width-auto uk-padding-remove-top uk-padding-remove-bottom"><span class="uk-link-heading" uk-icon="icon: code; ratio: 1.0;"></span></div><div class="uk-width-auto uk-padding-small uk-padding-remove-top uk-padding-remove-bottom">Source code</div></div></a>
        ...
        <li class="uk-link-toggle uk-card uk-card-hover uk-border-rounded"><!-- Delete Button :: START -->
