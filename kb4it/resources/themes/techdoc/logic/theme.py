...
class Theme(Builder):
    ...
    def build_page_index(self, var):
        ...
        self.log.info(f"[THEME] - Using webserver? {use_webserver}")
        ...
        self.log.info(f"[THEME] - Index page title: {var['repo']['title']}")
        ...
        self.srvdtb.add_document_key('index.adoc', 'System', '')
    ...
    def build_page_events(self):
        ...
        self.srvdtb.add_document_key('events.adoc', 'System', '')
    ...
    def build_page_properties(self):
        ...
        self.srvdtb.add_document_key('properties.adoc', 'System', '')
    ...
    def build_page_stats(self):
        ...
        self.srvdtb.add_document_key('stats.adoc', 'System', '')
    ...
    def build_page_bookmarks(self):
        ...
        self.srvdtb.add_document_key('bookmarks.adoc', 'System', '')
